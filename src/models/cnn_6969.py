def mini_concate_V4_XCEPTION(input_shape, num_classes, l2_regularization=0.01):
    ...
    branch1_4 = SeparableConv2D(16, (3, 3), padding='same',
                                kernel_regularizer=regularization,
                                use_bias=False)(x)
    ...
    x_1 = layers.concatenate([branch1_1, branch1_2, branch1_3, branch1_4], name='mixed1')
    ...
    x_2 = layers.concatenate([branch2_1, branch2_2, branch2_3, branch2_4], name='mixed2')
    ...
    branch3_3 = SeparableConv2D(16, (3, 3), padding='same',
                                kernel_regularizer=regularization,
                                use_bias=False)(branch3_3)
    branch3_3 = BatchNormalization()(branch3_3)
    ...
    x_3 = layers.concatenate([branch3_1, branch3_2, branch3_3, branch3_4], name='mixed3')
    ...
    x_4 = layers.concatenate([branch4_1, branch4_2, branch4_3, branch4_4], name='mixed4')
